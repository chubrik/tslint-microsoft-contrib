...
var GlobalReferenceCollector = (function (_super) {
    ...
    GlobalReferenceCollector.prototype.visitModuleDeclaration = function (node) { }; // do not descend into fresh scopes
    GlobalReferenceCollector.prototype.visitClassDeclaration = function (node) { }; // do not descend into fresh scopes
    GlobalReferenceCollector.prototype.visitArrowFunction = function (node) { }; // do not descend into fresh scopes
    GlobalReferenceCollector.prototype.visitFunctionExpression = function (node) { }; // do not descend into fresh scopes
